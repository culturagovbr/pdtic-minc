...
Percebe-se que a EGD busca estimular as ações de convergência de esforços quanto às infraestruturas, plataformas, sistemas e serviços entre os órgãos. Nesse sentido, o Ministério da Cultura já vem realizando diversas ações tanto com os órgãos integrantes do sistema MinC, por meio de um Comitê Integrado com representantes da TI de todos os órgãos (será detalhado adiante), como, também, por meio de parcerias com outros entes públicos externos ao sistema MinC.
...
reformular com base nos antigos.
...
--> escrever texto ligando CITIC a EGD.
...
Enfim, muitas são as possibilidades de ação conjunta geradas pelo CITIC.
MELHORAR TEXTO!!!!
...
# 9  PORTFOLIO DE PROJETOS

-- texto explicando a mudança de conceito de ações transformando em projetos --
Para o atendimento das necessidades priorizadas, foram identificados XXX projetos de TI, que foram incluídos no Portfólio e categorizados de acordo com a natureza das suas ações. A esses projetos foram adicionados mais 35 desde a versão 1.0 deste PDTI. O Portfólio de Projetos de TI é um instrumento de monitoramento contínuo da unidade de TI que substitui o Plano de Ação, pois determina como deverão ser alocados os recursos de TI, e possibilita que o Comitê Executivo de TI exerça a governança sobre as ações da unidade.
...
Sob a perspectiva de Orientação Futura, o Plano de Capacitação da CGTEC está diretamente relacionado com o Objetivo Estratégico da TI de nº 6 que é “Garantir desenvolvimento de competências na força de trabalho de TI” cuja descrição segue como:
...
| Indicador                          | Meta                                                                                            | 
|------------------------------------|-------------------------------------------------------------------------------------------------| 
| Plano interno de força de trabalho | Estabelecer um plano com medidas para garantir força de trabalho compatível com a demanda de TI | 
...
| Gestão e Governança de TI, ITIL® Foundation  e CobIT®                                        | 8                                             | 
...
| Planejamento de TI e elaboração de indicadores.                                              | 3                                             | 
...
| PHP Avançado                                                                                 | 4                                             | 
| Contratação de Soluções de TI de acordo com a IN SLTI/MP n° 04/2014 e atualizações           | 8                                             | 
