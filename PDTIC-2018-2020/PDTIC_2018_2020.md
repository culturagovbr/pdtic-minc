...
| NS4  | Banco de dados informações das fichas de monitoramento                           |                                                       | SDAPI            | 
...
| NS15 | Integrar bancos de dados do MEC aos da Política Nacional de Cultura Viva (Necessidades de informação)              |                                                                                                                                                                                                                                                                                                       | SDC              | 
...
| NS85 | Disponibilizar software para assinatura de documentos nos padrões do Sistema AFD (Aquisição)                         |                                                                                                                                                                                                                                                                                                            | SGE              | 
...
| NI4  |                                                 |                                                                                                                                           | GM                | 
| NI5  | Apoio técnico para implementação dos módulos disponibilizados pelo MPDG do sistema SIGEPE  e  AFD     ????????????????  (Necessidade de serviços)         | Apoio técnico, inclusive treinamento,  na implementação dos módulos  Sistemas de requisições, Férias Web e Controle de frequência do Sistema de Gestão de Pessoas - SIGEPE.  (Sistema de assentamentos funcionais digitais.)                                                                                                                | SGE              | 
| NI6  | Acesso a base de dados da Receita Federal                                                                                             |                                                                                                                                                                             | GM, SEFIC               | 
| NI7  |                                                                                               |                                                                                                                                                                                      | GM               | 
...
| NI12 | Dispobilizar Wiki corporativa para gestão de conhecimento e mapeamento de processos (necessidade de serviço)                              |                                                                                                                                                                                                    | SGE              | 
| NI13 |                                                               |                                                                                                                                                                                                                                                                                                                             | SEFIC             | 
| NI14 | Cruzar dados do Ministério da Cultura com o do Ministério do Trabalho                              |                                                                                                                               | SEFIC            | 
| NI15 | Acesso a sites de games, aplicativos e animação                                 |                                                                                                                                          | SAV              | 
