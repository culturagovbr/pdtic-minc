...
Figura 2 – Posição da CGTEC no MINC

Após a reestruturação do MinC, promovida pelo Decreto nº 8.837, de 17 de agosto de 2016, a estrutura da CGTEC fica sofreu reduções em seu quadro de servidores, resultando na Figura 3:

Figura 3 - Estrutura Atual da CGTEC
...
##6.2. Proposta de estrutura organizacional
...
Importante frisar que as ações tomadas para antender as necessidades levantadas no PDTIC anterior foram projetizadas. Com isso, o portfólio de projetos no período 2015-2017 totalizou 163 projetos de TI. A tabela analisada para compor os resultados pode ser vista em XXXX. O resultado dessa análise é apresentado a seguir:
...
| Situação        | Qtd | %           | 
|-----------------|-----|-------------| 
| 0. Não Iniciado | 24  | 0,147239264 | 
| 1. Pré-projeto  | 5   | 0,030674847 | 
| 2.              | 0   | 0           | 
| 3. Em execução  | 21  | 0,128834356 | 
| 4. Concluído    | 72  | 0,441717791 | 
| 5. Suspenso     | 20  | 0,122699387 | 
| 6. Cancelado    | 21  | 0,128834356 | 
...
|-----------------|-----|-------------| 
| Infra           | 29  | 0,17791411  | 
| Desenvolvimento | 74  | 0,45398773  | 
| Governança      | 22  | 0,134969325 | 
| Aquisição       | 38  | 0,233128834 | 
