...
| Id   | Descrição                                                                                                                                     | S | I | U | A | Prioridade | 
|------|-----------------------------------------------------------------------------------------------------------------------------------------------|---|---|---|---|------------| 
...
Nesta Proposta Orçamentária não há previsão para realização de adequações ou restrições na composição orçamentária deste PDTIC. 


## 10.1 Planos Internos

Os Planos Internos utilizados para controle de saldo de valores são instrumentos úteis ao planejamento da execução financeira desta CGTIC. O alinhamento das ações com seu respectivo PI traz um melhor controle sobre a execução financeira. 

Além disto, o programa de Pactuação de Desempenho prevê que todos os recursos orçamentários sejam detalhados na forma de PIs. Este programa é descrito na Portaria nº 149, de 21 de novembro de 2012 que institui o Programa de Pactuação de Desempenho no âmbito do Ministério da Cultura. Uma das diretrizes deste programa é, conforme Art. 2º item II da referida portaria, a adoção de procedimentos, métodos e modelos uniformes para todas as unidades, respeitadas as suas especificidades.

Abaixo, é apresentada uma tabela mostrando um consolidado de Planos Internos.

--tabela

Cabe lembrar que este consolidado de PIs é baseado na Previsão Orçamentária, e, portanto, deve sofrer alterações ao longo da vigência deste PDTI. Também é utilizado uma abreviação para representar o PI pois o código identificador do mesmo pode ser alterado a cada ano.
...
### 11.3 **R3** - Evasão de Servidores da Área de TI
...
# 12  PROCESSO DE REVISÃO DO PDTIC 
