...
São diretrizes da unidade de TI:
	
### 5.1 Diretriz Geral (DG):
...
## 6.1 Proposta de estrutura organizacional
...
| Infraestrutura de TI atualizada                                                                  | Sistemas críticos de TI rodando nas áreas finalísticas sem o apoio da CGTEC e sem integração          | 
| Utilização das últimas tecnologias de mercado                                                    | Alguns processos internos da CGTEC não são geridos e nem monitorados                                  | 
| Apoio da SGE e da Alta Administração                                                             | Não existe processo de garantia e controle da qualidade dos produtos e processos                      | 
...
|--------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------| 
| Ampliar a utilização de software livre                                                                                   | Alta rotatividade dos dirigentes do negócio                                                                                   | 
| Prover plataforma como serviço para entes da Administração Pública                                                       | Alta rotatividade e evasão do corpo gestor                                                                                    | 
| Promover a integração do Sistema MinC por meio da Comitê de TI formalmente instituído                                    | Interferência da política externa que impacta nas decisões estratégicas e operacionais internas                               | 
| Disponibilidade de diretrizes, normas, padrões e melhores práticas em Governança de TIC para órgãos públicos pela STI/MP | Percepção equivocada das atribuições da TI pelas áreas finalísticas                                                           | 
| Cooperação com outros órgãos da administração pública no compartilhamento de boas práticas de TIC                        | Os processos de negócio do Ministério não são mapeados, geridos e nem monitorados                                             | 
| Todas as áreas finalísticas dependem dos serviços de TI para o alcance dos objetivos estratégicos                        | Não existe escritório de projetos efetivo para garantir a gestão dos projetos de acordo com o plano estratégico do Ministério | 
| Lacunas a serem trabalhadas com relação à impessoalidade na prestação de serviços                                        | Não é realizada uma efetiva gestão da informação                                                                              | 
| Possibilidade de divulgação mais ampla dos serviços oferecidos pela TI                                                   | Baixa periodicidade de reuniões do Comitê de Governança Digital                                                               | 
| Possibilidade de aprimorar canais de comunicação para envolvimento prévio da CGTEC nos projetos finalísticos             | Corte de orçamento                                                                                                            | 
...
### 15.1 R1 - Descontinuidade dos negócios
...
### 15.2 R2 - Restrições orçamentárias
...
### 15.3 R3 - Evasão de Servidores da Área de TI
...
### 15.4 R4 - Insuficiência de Recursos Humanos
...
### 15.5 R5 - Falta de patrocínio da Alta Direção
...
## 18.2 Portfólio de Projetos

## 18.3 Catálogo de Sistemas
